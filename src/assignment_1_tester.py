...
from src import assignment_1_pgaines as MyAssignment
...
if __name__ == '__main__':
    try:
        ...
        with getopenconnection(dbname=DATABASE_NAME) as conn:
            ...
            # testrangepartition(RATINGS_TABLE, -1, conn, RANGE_TABLE_PREFIX, 0)
            # testrangepartition(RATINGS_TABLE, 5.6, conn, RANGE_TABLE_PREFIX, 0)
